            ...
            <div className="relative flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    {address ? (
                        ...
                        <button onClick={handleConnectWallet} className='flex items-center gap-3 justify-left rounded-xl border border-[#ffffff1a] border-gray-300 font-semibold bg-gradient-to-br from-[#ffffff] to-[#e6e6e6] p-3 px-6 text-sm leading-normal text-black shadow-sm hover:border-[#ececec] hover:to-[#ececec]'>

                            <svg fill="none" height="24" viewBox="0 0 35 33" width="26" xmlns="http://www.w3.org/2000/svg">
